        ...
        if (_params.bounds.isSimpleRange) {
            ...
            if (IndexBoundsBuilder::isSingleInterval(
                ...
                if (false == _indexJump.isEmpty()) {
                    ...
                    _seekPoint.keySuffix.resize(_params.bounds.fields.size());
                    _seekPoint.suffixInclusive.resize(_params.bounds.fields.size());
                    _seekPoint.keyPrefix = _indexJump;
                    _seekPoint.prefixLen = _params.bounds.fields.size();
